        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>Little Mushroom Store</strong> Login Form</h1>
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="{{route('user.do_login')}}" method="post" class="login-form">
                            {{csrf_field()}}
...
<script>
    ...
    @if(Session::has('login_alert'))
        alert_slide("{{Session::get('login_alert')}}");
    @endif
</script>
