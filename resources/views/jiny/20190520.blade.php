...
<script type="text/javascript">
    ...
    function alert_line() {
        ...
        alert('~~~');
        alert('Do you know...');
        alert('Today is a special day?');
        alert('Maybe...');
        alert('I will do something you like?');
        alert('Such as a scary animation?');
        alert('a threating letter?');
        alert('some greasy sentences?');
        alert('~');
        alert('I believe that...');
        alert('you\'ve probably never seen anything so ...');
        alert('Strange?');
        alert('...');
        alert('Then...');
